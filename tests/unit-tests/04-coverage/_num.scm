...
(let ((arg 1)) (check-eq? arg (* 1 arg)))
(let ((arg 1)) (check-eq? arg (* arg 1)))
(let ((arg 1)) (check-eq? arg (+ 0 arg)))
(let ((arg 1)) (check-eq? arg (+ arg 0)))
(let ((arg 1)) (check-eq? arg (/ arg 1)))
(let ((arg 1)) (check-eq? arg (- arg 0)))
(let ((arg 1267650600228229401496703205376)) (check-eq? arg (* 1 arg)))
(let ((arg 1267650600228229401496703205376)) (check-eq? arg (* arg 1)))
(let ((arg 1267650600228229401496703205376)) (check-eq? arg (+ 0 arg)))
(let ((arg 1267650600228229401496703205376)) (check-eq? arg (+ arg 0)))
(let ((arg 1267650600228229401496703205376)) (check-eq? arg (/ arg 1)))
(let ((arg 1267650600228229401496703205376)) (check-eq? arg (- arg 0)))
(let ((arg 1/2)) (check-eq? arg (* 1 arg)))
(let ((arg 1/2)) (check-eq? arg (* arg 1)))
(let ((arg 1/2)) (check-eq? arg (+ 0 arg)))
(let ((arg 1/2)) (check-eq? arg (+ arg 0)))
(let ((arg 1/2)) (check-eq? arg (/ arg 1)))
(let ((arg 1/2)) (check-eq? arg (- arg 0)))
(let ((arg 1.)) (check-eq? arg (* 1 arg)))
(let ((arg 1.)) (check-eq? arg (* arg 1)))
...
(let ((arg 1.)) (check-eq? arg (/ arg 1)))
(let ((arg 1.)) (check-eq? arg (- arg 0)))
(let ((arg 1+i)) (check-eq? arg (* 1 arg)))
(let ((arg 1+i)) (check-eq? arg (* arg 1)))
(let ((arg 1+i)) (check-eq? arg (+ 0 arg)))
(let ((arg 1+i)) (check-eq? arg (+ arg 0)))
(let ((arg 1+i)) (check-eq? arg (/ arg 1)))
(let ((arg 1+i)) (check-eq? arg (- arg 0)))
...
(check-eqv? (arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 25) (test-arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 25))
(check-eqv? (arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 6) (test-arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 6))
(check-eqv? (arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 -85) (test-arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 -85))
(check-eqv? (arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 -7) (test-arithmetic-shift 1510654584040625753730018974833480216667530151201555010392492426076866671982958500628614593424711863814629067143762706485 -7))
(check-eqv? (arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 25) (test-arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 25))
(check-eqv? (arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 6) (test-arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 6))
(check-eqv? (arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 -85) (test-arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 -85))
(check-eqv? (arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 -7) (test-arithmetic-shift -559642383537053245096412692765977685103422952228866058440690017354464196389779391618197852441636114137703871379414475911 -7))
