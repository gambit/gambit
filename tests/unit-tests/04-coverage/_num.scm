...
(let ((arg 1)) (check-eq? (* 1 arg) arg))
(let ((arg 1)) (check-eq? (* arg 1) arg))
(let ((arg 1)) (check-eq? (+ 0 arg) arg))
(let ((arg 1)) (check-eq? (+ arg 0) arg))
(let ((arg 1267650600228229401496703205376)) (check-eq? (* 1 arg) arg))
(let ((arg 1267650600228229401496703205376)) (check-eq? (* arg 1) arg))
(let ((arg 1267650600228229401496703205376)) (check-eq? (+ 0 arg) arg))
(let ((arg 1267650600228229401496703205376)) (check-eq? (+ arg 0) arg))
(let ((arg 1/2)) (check-eq? (* 1 arg) arg))
(let ((arg 1/2)) (check-eq? (* arg 1) arg))
(let ((arg 1/2)) (check-eq? (+ 0 arg) arg))
(let ((arg 1/2)) (check-eq? (+ arg 0) arg))
(let ((arg 1.)) (check-eq? (* 1 arg) arg))
(let ((arg 1.)) (check-eq? (* arg 1) arg))
(let ((arg 1.)) (check-eq? (+ 0 arg) arg))
(let ((arg 1.)) (check-eq? (+ arg 0) arg))
(let ((arg 1+i)) (check-eq? (* 1 arg) arg))
(let ((arg 1+i)) (check-eq? (* arg 1) arg))
(let ((arg 1+i)) (check-eq? (+ 0 arg) arg))
