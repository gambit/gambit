...
(check-same-behavior
 ...
 (f64vector-append)
 (f64vector-append '#f64(1.))
 (f64vector-append '#f64(1.) '#f64(2.))
 (f64vector-append '#f64(1.) '#f64(2.) '#f64(3.))
 (f64vector-copy '#f64(1. 2. 3. 4. 5.))
 (f64vector-copy '#f64(1. 2. 3. 4. 5.) 1)
 (f64vector-copy '#f64(1. 2. 3. 4. 5.) 1 3)
 (let ((x (f64vector 1. 2. 3. 4.)) (y (f64vector 6. 7. 8. 9. 0.)))
   (f64vector-copy! y 1 x)
   y)
 (let ((x (f64vector 1. 2. 3. 4.)) (y (f64vector 6. 7. 8. 9. 0.)))
   (f64vector-copy! y 1 x 2)
   y)
 (let ((x (f64vector 1. 2. 3. 4.)) (y (f64vector 6. 7. 8. 9. 0.)))
   (f64vector-copy! y 1 x 2 3)
   y)
