...
(check-same-behavior
 ...
 (f32vector-append)
 (f32vector-append '#f32(1.))
 (f32vector-append '#f32(1.) '#f32(2.))
 (f32vector-append '#f32(1.) '#f32(2.) '#f32(3.))
 (f32vector-copy '#f32(1. 2. 3. 4. 5.))
 (f32vector-copy '#f32(1. 2. 3. 4. 5.) 1)
 (f32vector-copy '#f32(1. 2. 3. 4. 5.) 1 3)
 (let ((x (f32vector 1. 2. 3. 4.)) (y (f32vector 6. 7. 8. 9. 0.)))
   (f32vector-copy! y 1 x)
   y)
 (let ((x (f32vector 1. 2. 3. 4.)) (y (f32vector 6. 7. 8. 9. 0.)))
   (f32vector-copy! y 1 x 2)
   y)
 (let ((x (f32vector 1. 2. 3. 4.)) (y (f32vector 6. 7. 8. 9. 0.)))
   (f32vector-copy! y 1 x 2 3)
   y)
