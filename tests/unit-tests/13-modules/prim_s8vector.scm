...
(check-same-behavior
 ("" "##" "~~lib/gambit/prim/s8vector#.scm")
 
 ;; Gambit
 
 (s8vector-concatenate '(#s8(1) #s8(2) #s8(3)))
 (list->s8vector '(1 2 3))
 (s8vector-length (make-s8vector 5))
 (make-s8vector 5 9)
 (subs8vector '#s8(1 2 3 4 5) 1 3)
 
 (let ((x (s8vector 1 2 3 4 5))) (subs8vector-fill! x 1 3 99) x)
 (let ((x (s8vector 1 2 3 4)) (y (s8vector 6 7 8 9 0)))
   (subs8vector-move! x 2 3 y 1)
   y)
 (s8vector)
 (s8vector 1)
 (s8vector 1 2)
 ...
 (s8vector-append)
 (s8vector-append '#s8(1))
 (s8vector-append '#s8(1) '#s8(2))
 (s8vector-append '#s8(1) '#s8(2) '#s8(3))
 ...
 (let ((x (s8vector 1 2 3 4)) (y (s8vector 6 7 8 9 0)))
   ...
   y)
 (let ((x (s8vector 1 2 3 4)) (y (s8vector 6 7 8 9 0)))
   (s8vector-copy! y 1 x 2)
   y)
 (let ((x (s8vector 1 2 3 4)) (y (s8vector 6 7 8 9 0)))
   (s8vector-copy! y 1 x 2 3)
   y)
 ...
 (let ((x (s8vector 1 2 3 4 5))) (s8vector-swap! x 2 3) x)
