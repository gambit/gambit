...
(check-same-behavior
 ...
 (####k ";;unimplemented;;nonempty-input-port-character-buffer-exception-arguments"
        ipkvm)
 (####k ";;unimplemented;;nonempty-input-port-character-buffer-exception-procedure"
        ipkvm)
 (####k ";;unimplemented;;nonempty-input-port-character-buffer-exception?"
        ipkvm)
 ...
 (####k ";;unimplemented;;unbound-os-environment-variable-exception-arguments"
        ipkvm)
 (####k ";;unimplemented;;unbound-os-environment-variable-exception-procedure"
        ipkvm)
