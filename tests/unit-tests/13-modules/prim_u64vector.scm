...
(check-same-behavior
 ...
 (u64vector-append)
 (u64vector-append '#u64(1))
 (u64vector-append '#u64(1) '#u64(2))
 (u64vector-append '#u64(1) '#u64(2) '#u64(3))
 (u64vector-copy '#u64(1 2 3 4 5))
 (u64vector-copy '#u64(1 2 3 4 5) 1)
 (u64vector-copy '#u64(1 2 3 4 5) 1 3)
 (let ((x (u64vector 1 2 3 4)) (y (u64vector 6 7 8 9 0)))
   (u64vector-copy! y 1 x)
   y)
 (let ((x (u64vector 1 2 3 4)) (y (u64vector 6 7 8 9 0)))
   (u64vector-copy! y 1 x 2)
   y)
 (let ((x (u64vector 1 2 3 4)) (y (u64vector 6 7 8 9 0)))
   (u64vector-copy! y 1 x 2 3)
   y)
