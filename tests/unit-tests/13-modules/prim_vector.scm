...
(check-same-behavior
 ...
 (####k ";;unimplemented;;(vector-for-each vector '#(1 2)) (vector-for-each vector '#(1) '#(2)) (vector-for-each vector '#(1) '#(2) '#(3))"
        ipkvm)
 (####k ";;unimplemented;;(vector-map vector '#(1 2)) (vector-map vector '#(1) '#(2)) (vector-map vector '#(1) '#(2) '#(3))"
        ipkvm)
 ...
 (let ((x (vector 1 2 3 4)) (y (vector 6 7 8 9 0)))
   (subvector-move! x 2 3 y 1)
   y)
