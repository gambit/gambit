...
(check-same-behavior ("" "##" "~~lib/_prim-filesystem#.scm")
...
;;unimplemented;;(let ((x "test_file.txt")) (##with-output-to-file x ##list) (file-last-access-and-modification-times-set! x) (delete-file x))
;;unimplemented;;(let ((x "test_file.txt")) (##with-output-to-file x ##list) (file-last-access-and-modification-times-set! x -1) (delete-file x))
;;unimplemented;;(let ((x "test_file.txt")) (##with-output-to-file x ##list) (file-last-access-and-modification-times-set! x -1 -2) (delete-file x))
