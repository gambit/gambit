...
(check-same-behavior
 ...
 (s32vector-append)
 (s32vector-append '#s32(1))
 (s32vector-append '#s32(1) '#s32(2))
 (s32vector-append '#s32(1) '#s32(2) '#s32(3))
 (s32vector-copy '#s32(1 2 3 4 5))
 (s32vector-copy '#s32(1 2 3 4 5) 1)
 (s32vector-copy '#s32(1 2 3 4 5) 1 3)
 (let ((x (s32vector 1 2 3 4)) (y (s32vector 6 7 8 9 0)))
   (s32vector-copy! y 1 x)
   y)
 (let ((x (s32vector 1 2 3 4)) (y (s32vector 6 7 8 9 0)))
   (s32vector-copy! y 1 x 2)
   y)
 (let ((x (s32vector 1 2 3 4)) (y (s32vector 6 7 8 9 0)))
   (s32vector-copy! y 1 x 2 3)
   y)
