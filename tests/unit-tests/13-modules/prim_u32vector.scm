...
(check-same-behavior
 ...
 (u32vector-append)
 (u32vector-append '#u32(1))
 (u32vector-append '#u32(1) '#u32(2))
 (u32vector-append '#u32(1) '#u32(2) '#u32(3))
 (u32vector-copy '#u32(1 2 3 4 5))
 (u32vector-copy '#u32(1 2 3 4 5) 1)
 (u32vector-copy '#u32(1 2 3 4 5) 1 3)
 (let ((x (u32vector 1 2 3 4)) (y (u32vector 6 7 8 9 0)))
   (u32vector-copy! y 1 x)
   y)
 (let ((x (u32vector 1 2 3 4)) (y (u32vector 6 7 8 9 0)))
   (u32vector-copy! y 1 x 2)
   y)
 (let ((x (u32vector 1 2 3 4)) (y (u32vector 6 7 8 9 0)))
   (u32vector-copy! y 1 x 2 3)
   y)
