...
(check-same-behavior
 ...
 (s16vector-append)
 (s16vector-append '#s16(1))
 (s16vector-append '#s16(1) '#s16(2))
 (s16vector-append '#s16(1) '#s16(2) '#s16(3))
 (s16vector-copy '#s16(1 2 3 4 5))
 (s16vector-copy '#s16(1 2 3 4 5) 1)
 (s16vector-copy '#s16(1 2 3 4 5) 1 3)
 (let ((x (s16vector 1 2 3 4)) (y (s16vector 6 7 8 9 0)))
   (s16vector-copy! y 1 x)
   y)
 (let ((x (s16vector 1 2 3 4)) (y (s16vector 6 7 8 9 0)))
   (s16vector-copy! y 1 x 2)
   y)
 (let ((x (s16vector 1 2 3 4)) (y (s16vector 6 7 8 9 0)))
   (s16vector-copy! y 1 x 2 3)
   y)
 ...
 (let ((x (s16vector 1 2 3 4 5))) (s16vector-swap! x 2 3) x)
