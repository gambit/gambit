...
(let ((arg 1/2)) (check-eq? arg (/ arg 1)))
(let ((arg 1/2)) (check-eq? arg (- arg 0)))
(let ((arg (##first-argument 1.))) (check-eq? arg (* 1 arg)))
(let ((arg (##first-argument 1.))) (check-eq? arg (* arg 1)))
(let ((arg (##first-argument 1.))) (check-eq? arg (+ 0 arg)))
(let ((arg (##first-argument 1.))) (check-eq? arg (+ arg 0)))
(let ((arg (##first-argument 1.))) (check-eq? arg (/ arg 1)))
(let ((arg (##first-argument 1.))) (check-eq? arg (- arg 0)))
