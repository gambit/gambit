...
;; (test-eqv (expt -0. -inf.0) +inf.0) ;; FAILED (test-eqv (expt -0. -inf.0) +inf.0) GOT +nan.0+nan.0i
...
;;     pow(-1, ±∞) returns 1
;; (test-eqv 1. (expt -1. +inf.0) 1.) ;; FAILED (test-eqv (expt -1. +inf.0) ) GOT +nan.0+nan.0i
;; (test-eqv 1. (expt -1. -inf.0) 1.) ;; FAILED (test-eqv (expt -1. -inf.0) ) GOT +nan.0+nan.0i
...
;; (test-eqv +inf.0 (expt -1/2 -inf.0)) ;; FAILED (test-eqv (expt -1/2 -inf.0) +inf.0) GOT +nan.0+nan.0i
(test-eqv +inf.0 (expt .5 -inf.0))
;; (test-eqv +inf.0 (expt -0.5 -inf.0)) ;; FAILED (test-eqv (expt -.5 -inf.0) +inf.0) GOT +nan.0+nan.0i


;;     pow(base, -∞) returns +0 for any |base|>1
(test-eqv 0. (expt 3/2 -inf.0))
;; (test-eqv +0. (expt -3/2 -inf.0)) ;; FAILED (test-eqv (expt -3/2 -inf.0) 0.) GOT +nan.0+nan.0i
(test-eqv 0. (expt 1.5 -inf.0))
;; (test-eqv +0. (expt -1.5 -inf.0)) ;; FAILED (test-eqv (expt -1.5 -inf.0) 0.) GOT +nan.0+nan.0i

;;     pow(base, +∞) returns +0 for any |base|<1
(test-eqv 0. (expt 1/2 +inf.0))
;; (test-eqv +0. (expt -1/2 +inf.0)) ;; FAILED (test-eqv (expt -1/2 +inf.0) 0.) GOT +nan.0+nan.0i
(test-eqv 0. (expt .5 +inf.0))
;; (test-eqv +0. (expt -0.5 +inf.0)) ;; FAILED (test-eqv (expt -.5 +inf.0) 0.) GOT +nan.0+nan.0i

;;     pow(base, +∞) returns +∞ for any |base|>1
(test-eqv +inf.0 (expt 3/2 +inf.0))
;; (test-eqv +inf.0 (expt -3/2 +inf.0)) ;; FAILED (test-eqv (expt -3/2 +inf.0) +inf.0) GOT +nan.0+nan.0i
(test-eqv +inf.0 (expt 1.5 +inf.0))
;; (test-eqv +inf.0 (expt -1.5 +inf.0)) ;; FAILED (test-eqv (expt -1.5 +inf.0) +inf.0) GOT +nan.0+nan.0i
...
(test-eqv 0. (expt -inf.0 -2.))
;; (test-eqv +0. (expt -inf.0 -3/2))   ;; FAILED (test-eqv (expt -inf.0 -3/2) 0.) GOT +0.i
;; (test-eqv +0. (expt -inf.0 #i-3/2)) ;; FAILED (test-eqv (expt -inf.0 -1.5) 0.) GOT -0.+0.i
...
(test-eqv +inf.0 (expt -inf.0 4.))
;; (test-eqv +inf.0 (expt -inf.0 #e4.5)) ;; FAILED (test-eqv (expt -inf.0 9/2) +inf.0) GOT +inf.0i
;; (test-eqv +inf.0 (expt -inf.0 4.5))   ;; FAILED (test-eqv (expt -inf.0 4.5) +inf.0) GOT +inf.0+inf.0i
