...
(define t1 (make-thread (lambda () (thread-sleep! .02) (println "t1 ending"))))

(define t2 (make-thread (lambda () (thread-sleep! .02) (println "t2 ending"))))

(define t3 (make-thread (lambda () (println "t3 ending"))))

(define t4 (make-thread (lambda () (println "t4 ending"))))
