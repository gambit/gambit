...
(test-equal
 ""
 (with-input-from-string "" (lambda () (read-string 0))))

(test-equal
 #!eof
 (with-input-from-string "" (lambda () (read-string 1))))

(test-equal
 "abcd"
 (with-input-from-string "abcd" (lambda () (read-string 4))))

(test-equal
 "abcd"
 (with-input-from-string "abcd" (lambda () (read-string 9))))
