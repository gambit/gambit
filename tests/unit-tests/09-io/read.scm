...
(test-equal
 123
 (with-input-from-string "123" (lambda () (read))))
...
(test-equal
 1.25
 (with-input-from-string "1.25" (lambda () (read))))

(test-equal
 #t
 (with-input-from-string "#t" (lambda () (read))))

(test-equal
 #f
 (with-input-from-string "#f" (lambda () (read))))

(test-equal
 #\space
 (with-input-from-string "#\\space" (lambda () (read))))
...
(test-equal
 'sym
 (with-input-from-string "sym" (lambda () (read))))

(test-equal
 'key:
 (with-input-from-string "key:" (lambda () (read))))

(test-equal
 #(1 2 3)
 (with-input-from-string "#(1 2 3)" (lambda () (read))))
