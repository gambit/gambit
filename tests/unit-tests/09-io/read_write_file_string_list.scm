...
(test-equal '() (read-file-string-list "read_write_file_string_list_temp"))

(delete-file "read_write_file_string_list_temp")

(test-error-tail wrong-number-of-arguments-exception? (write-file-string-list))
(test-error-tail
...
(test-error-tail wrong-number-of-arguments-exception? (read-file-string-list))
(test-error-tail
 wrong-number-of-arguments-exception?
