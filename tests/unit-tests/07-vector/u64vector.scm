...
(check-eqv? (##u64vector-swap! v2 0 4) v2)

(check-eqv? (##u64vector-ref v2 0) 18446744073709551615)
(check-eqv? (##u64vector-ref v2 1) 99)
(check-eqv? (##u64vector-ref v2 2) 0)
(check-eqv? (##u64vector-ref v2 3) 1)
(check-eqv? (##u64vector-ref v2 4) 0)
...
(check-equal? (u64vector-concatenate (list v6 v7 v6)) '#u64(0 18446744073709551615 0 1 18446744073709551615 0 0 0 18446744073709551615 0 1 18446744073709551615))
(check-equal? (u64vector-concatenate (list v6 v7 v6) '#u64(1 1 1)) '#u64(0 18446744073709551615 0 1 18446744073709551615 1 1 1 0 0 1 1 1 0 18446744073709551615 0 1 18446744073709551615))
...
(check-eq? (u64vector-swap! v6 0 4) (void))

(check-eqv? (u64vector-ref v6 0) 18446744073709551615)
(check-eqv? (u64vector-ref v6 1) 99)
(check-eqv? (u64vector-ref v6 2) 0)
(check-eqv? (u64vector-ref v6 3) 1)
(check-eqv? (u64vector-ref v6 4) 0)
...
(check-tail-exn type-exception? (lambda () (u64vector-concatenate bool)))
(check-tail-exn type-exception? (lambda () (u64vector-concatenate '(1 2 3))))
(check-tail-exn type-exception? (lambda () (u64vector-concatenate (list v9 v9) bool)))
...
(check-tail-exn type-exception? (lambda () (u64vector-swap! bool 0 11)))
(check-tail-exn type-exception? (lambda () (u64vector-swap! v5 bool 11)))
(check-tail-exn type-exception? (lambda () (u64vector-swap! v5 0 bool)))
(check-tail-exn range-exception? (lambda () (u64vector-swap! v5 -1 0)))
(check-tail-exn range-exception? (lambda () (u64vector-swap! v5 10 0)))
...
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u64vector-concatenate)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u64vector-concatenate '() '() '())))
...
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u64vector-swap!)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u64vector-swap! v9)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u64vector-swap! v9 0)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u64vector-swap! v9 0 0 0 0)))
