...
(check-eqv? (##u8vector-swap! v2 0 4) v2)

(check-eqv? (##u8vector-ref v2 0) 255)
(check-eqv? (##u8vector-ref v2 1) 99)
(check-eqv? (##u8vector-ref v2 2) 0)
(check-eqv? (##u8vector-ref v2 3) 1)
(check-eqv? (##u8vector-ref v2 4) 0)
...
(check-equal? (u8vector-concatenate (list v6 v7 v6)) '#u8(0 255 0 1 255 0 0 0 255 0 1 255))
(check-equal? (u8vector-concatenate (list v6 v7 v6) '#u8(1 1 1)) '#u8(0 255 0 1 255 1 1 1 0 0 1 1 1 0 255 0 1 255))
...
(check-eq? (u8vector-swap! v6 0 4) (void))

(check-eqv? (u8vector-ref v6 0) 255)
(check-eqv? (u8vector-ref v6 1) 99)
(check-eqv? (u8vector-ref v6 2) 0)
(check-eqv? (u8vector-ref v6 3) 1)
(check-eqv? (u8vector-ref v6 4) 0)
...
(check-tail-exn type-exception? (lambda () (u8vector-concatenate bool)))
(check-tail-exn type-exception? (lambda () (u8vector-concatenate '(1 2 3))))
(check-tail-exn type-exception? (lambda () (u8vector-concatenate (list v9 v9) bool)))
...
(check-tail-exn type-exception? (lambda () (u8vector-swap! bool 0 11)))
(check-tail-exn type-exception? (lambda () (u8vector-swap! v5 bool 11)))
(check-tail-exn type-exception? (lambda () (u8vector-swap! v5 0 bool)))
(check-tail-exn range-exception? (lambda () (u8vector-swap! v5 -1 0)))
(check-tail-exn range-exception? (lambda () (u8vector-swap! v5 10 0)))
...
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u8vector-concatenate)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u8vector-concatenate '() '() '())))
...
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u8vector-swap!)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u8vector-swap! v9)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u8vector-swap! v9 0)))
(check-tail-exn wrong-number-of-arguments-exception? (lambda () (u8vector-swap! v9 0 0 0 0)))
