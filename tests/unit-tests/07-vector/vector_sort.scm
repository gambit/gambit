...
(test-equal
 ...
 (vector-sort (lambda (x y) (< (car x) (car y))) '#((33 1) (22 2) (55 3) (22 4) (11 5) (33 6) (55 7))))

(test-equal
 '#((33 1) (22 2) (11 5) (22 4) (33 6) (55 3) (55 7))
 (vector-sort (lambda (x y) (< (car x) (car y))) '#((33 1) (22 2) (55 3) (22 4) (11 5) (33 6) (55 7)) 2))

(test-equal
 '#((33 1) (22 2) (11 5) (22 4) (55 3) (33 6) (55 7))
 (vector-sort (lambda (x y) (< (car x) (car y))) '#((33 1) (22 2) (55 3) (22 4) (11 5) (33 6) (55 7)) 2 5))

(test-equal
 '#((33 1) (22 2) (55 3) (22 4) (11 5) (33 6) (55 7))
 (vector-sort (lambda (x y) (< (car x) (car y))) '#((33 1) (22 2) (55 3) (22 4) (11 5) (33 6) (55 7)) 2 2))
