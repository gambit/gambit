...
(let* ((x '())) (try* x 'concatenate concatenate x))
(let* ((y '()) (x (list y))) (try* (list y x) 'concatenate concatenate x))
(let* ((z '()) (y '()) (x (list z y))) (try* (list z y x) 'concatenate concatenate x))
(let* ((y (cons 1 2)) (x (list y))) (try* (list y x) 'concatenate concatenate x))
(let* ((z (cons 1 2)) (y (list 3 4)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x))
(let* ((z '()) (y (list 1 2)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x))
(let* ((z '()) (y (cons 1 2)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x))
(let* ((z (list 1 2)) (y (cons 3 4)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x))
(let* ((x (cons 1 2))) (try* x 'concatenate concatenate x))
(let* ((x #f)) (try* x 'concatenate concatenate x))
(let* ((x '())) (try* x 'concatenate concatenate x '()))
(let* ((y '()) (x (list y))) (try* (list y x) 'concatenate concatenate x '()))
(let* ((z '()) (y '()) (x (list z y))) (try* (list z y x) 'concatenate concatenate x '()))
(let* ((y (cons 1 2)) (x (list y))) (try* (list y x) 'concatenate concatenate x '()))
...
(let* ((x (cons 1 2))) (try* x 'concatenate concatenate x '()))
(let* ((x #f)) (try* x 'concatenate concatenate x '()))
(let* ((x '())) (try* x 'concatenate concatenate x #f))
(let* ((y '()) (x (list y))) (try* (list y x) 'concatenate concatenate x #f))
(let* ((z '()) (y '()) (x (list z y))) (try* (list z y x) 'concatenate concatenate x #f))
(let* ((y (cons 1 2)) (x (list y))) (try* (list y x) 'concatenate concatenate x #f))
(let* ((z (cons 1 2)) (y (list 3 4)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x #f))
(let* ((z '()) (y (list 1 2)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x #f))
(let* ((z '()) (y (cons 1 2)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x #f))
(let* ((z (list 1 2)) (y (cons 3 4)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x #f))
(let* ((x (cons 1 2))) (try* x 'concatenate concatenate x #f))
(let* ((x #f)) (try* x 'concatenate concatenate x #f))
(let* ((x '())) (try* x 'concatenate concatenate x '(8 . 9)))
(let* ((y '()) (x (list y))) (try* (list y x) 'concatenate concatenate x '(8 . 9)))
(let* ((z '()) (y '()) (x (list z y))) (try* (list z y x) 'concatenate concatenate x '(8 . 9)))
(let* ((y (cons 1 2)) (x (list y))) (try* (list y x) 'concatenate concatenate x '(8 . 9)))
(let* ((z (cons 1 2)) (y (list 3 4)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x '(8 . 9)))
(let* ((z '()) (y (list 1 2)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x '(8 . 9)))
(let* ((z '()) (y (cons 1 2)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x '(8 . 9)))
(let* ((z (list 1 2)) (y (cons 3 4)) (x (list z y))) (try* (list z y x) 'concatenate concatenate x '(8 . 9)))
(let* ((x (cons 1 2))) (try* x 'concatenate concatenate x '(8 . 9)))
(let* ((x '(8 . 9))) (try* x 'concatenate concatenate x '(8 . 9)))
(let* ((x '())) (try* x 'concatenate concatenate x '(8 9)))
(let* ((y '()) (x (list y))) (try* (list y x) 'concatenate concatenate x '(8 9)))
(let* ((z '()) (y '()) (x (list z y))) (try* (list z y x) 'concatenate concatenate x '(8 9)))
(let* ((y (cons 1 2)) (x (list y))) (try* (list y x) 'concatenate concatenate x '(8 9)))
