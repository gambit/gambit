...
(define **define-hygienic-macro-sym     (string->canonical-symbol "##define-hygienic-macro"))
(define **define-hygienic-syntax-sym    (string->canonical-symbol "##define-hygienic-syntax"))
...
(define (compiler-version) 407007) ;; 100000*major + 1000*minor + revision
