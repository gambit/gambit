...
(define arm-primitive-table
  (let ((table (make-table test: equal?)))
    ...
    (table-set! table '##boolean?       (make-prim-obj (arm-prim-##boolean-or? tru-desc)  1 #t #t))
    (table-set! table '##false-or-null? (make-prim-obj (arm-prim-##boolean-or? nul-desc)  1 #t #t))
    (table-set! table '##false-or-void? (make-prim-obj (arm-prim-##boolean-or? void-desc) 1 #t #t))

    (table-set! table '##subtyped?     (make-prim-obj arm-prim-##subtyped? 1 #t #t))
    (table-set! table '##vector?       (make-prim-obj (arm-prim-##subtype? vector-desc)       1 #t #t))
    (table-set! table '##ratnum?       (make-prim-obj (arm-prim-##subtype? ratnum-desc)       1 #t #t))
    (table-set! table '##cpxnum?       (make-prim-obj (arm-prim-##subtype? cpxnum-desc)       1 #t #t))
    (table-set! table '##structure?    (make-prim-obj (arm-prim-##subtype? structure-desc)    1 #t #t))
    (table-set! table '##meroon?       (make-prim-obj (arm-prim-##subtype? meroon-desc)       1 #t #t))
    (table-set! table '##jazz?         (make-prim-obj (arm-prim-##subtype? jazz-desc)         1 #t #t))
    (table-set! table '##symbol?       (make-prim-obj (arm-prim-##subtype? symbol-desc)       1 #t #t))
    (table-set! table '##keyword?      (make-prim-obj (arm-prim-##subtype? keyword-desc)      1 #t #t))
    (table-set! table '##frame?        (make-prim-obj (arm-prim-##subtype? frame-desc)        1 #t #t))
    (table-set! table '##continuation? (make-prim-obj (arm-prim-##subtype? continuation-desc) 1 #t #t))
    (table-set! table '##promise?      (make-prim-obj (arm-prim-##subtype? promise-desc)      1 #t #t))
    (table-set! table '##procedure?    (make-prim-obj (arm-prim-##subtype? procedure-desc)    1 #t #t))
    (table-set! table '##return?       (make-prim-obj (arm-prim-##subtype? return-desc)       1 #t #t))
    (table-set! table '##foreign?      (make-prim-obj (arm-prim-##subtype? foreign-desc)      1 #t #t))
    (table-set! table '##string?       (make-prim-obj (arm-prim-##subtype? string-desc)       1 #t #t))
    (table-set! table '##s8vector?     (make-prim-obj (arm-prim-##subtype? s8vector-desc)     1 #t #t))
    (table-set! table '##u8vector?     (make-prim-obj (arm-prim-##subtype? u8vector-desc)     1 #t #t))
    (table-set! table '##s16vector?    (make-prim-obj (arm-prim-##subtype? s16vector-desc)    1 #t #t))
    (table-set! table '##u16vector?    (make-prim-obj (arm-prim-##subtype? u16vector-desc)    1 #t #t))
    (table-set! table '##s32vector?    (make-prim-obj (arm-prim-##subtype? s32vector-desc)    1 #t #t))
    (table-set! table '##u32vector?    (make-prim-obj (arm-prim-##subtype? u32vector-desc)    1 #t #t))
    (table-set! table '##f32vector?    (make-prim-obj (arm-prim-##subtype? f32vector-desc)    1 #t #t))
    (table-set! table '##s64vector?    (make-prim-obj (arm-prim-##subtype? s64vector-desc)    1 #t #t))
    (table-set! table '##u64vector?    (make-prim-obj (arm-prim-##subtype? u64vector-desc)    1 #t #t))
    (table-set! table '##f64vector?    (make-prim-obj (arm-prim-##subtype? f64vector-desc)    1 #t #t))
    (table-set! table '##flonum?       (make-prim-obj (arm-prim-##subtype? flonum-desc)       1 #t #t))
    (table-set! table '##bignum?       (make-prim-obj (arm-prim-##subtype? bignum-desc)       1 #t #t))
