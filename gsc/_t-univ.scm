    ...
    ((str_hash)
     (^prim-function-declaration
      ...
      (let ((strng (^local-var 'strng))
            ...
            (i (^local-var 'i))
            (leng (^local-var 'leng)))
        (^ (^var-declaration h (^int 0))
           (^var-declaration i (^int 0))
           (^var-declaration leng (^str-length strng))
           (^while (^< i leng)
                   (^ (^assign h
                               (^bitand
                                (^parens
