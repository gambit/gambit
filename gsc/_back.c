...
; File: "_back.c", produced by Gambit v4.8.1
(
408001
(C)
"_back"
...
___DEF_GLBL(___L29_c_23_get_2d_link_2d_info)
   ...
   ___SET_STK(5,___R3)
   ___SET_STK(6,___R4)
   ___SET_R1(___VECTORREF(___R4,___FIX(4L)))
   ___SET_STK(7,___R1)
   ___SET_R1(___FAL)
   ___SET_R0(___LBL(7))
   ___ADJFP(12)
...
___DEF_SLBL(17,___L17_c_23_get_2d_link_2d_info)
   ___BEGIN_ALLOC_LIST(3,___STK(-7))
...
,___DEF_LBL_RET(___H_c_23_link_2d_modules,___OFD(___RETI,12,12,0x3f005L))
...
,___DEF_LBL_RET(___H_c_23_get_2d_link_2d_info,___OFD(___RETI,12,1,0x3f07fL))
