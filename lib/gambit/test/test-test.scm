...
(check-equal? (failure-msg (lambda () (check-exn pair?
                                                 (lambda () (/ 1 0)))))
              "\"test-test.scm\"@75.39: FAILED (check-exn pair? (lambda () (/ 1 0))) GOT #<divide-by-zero-exception #2>\n")
(check-equal? (failure-msg (lambda () (check-exn divide-by-zero-exception?
                                                 (lambda () (/ 1 2)))))
              "\"test-test.scm\"@78.39: FAILED (check-exn divide-by-zero-exception? (lambda () (/ 1 2))) GOT 1/2\n")
...
(check-equal? (failure-msg (lambda () (check-tail-exn pair?
                                                      (lambda () (/ 1 0)))))
              "\"test-test.scm\"@87.39: FAILED (check-tail-exn pair? (lambda () (/ 1 0))) GOT #<divide-by-zero-exception #3>\n")
(check-equal? (failure-msg (lambda () (check-tail-exn divide-by-zero-exception?
                                                      (lambda () (/ 1 2)))))
              "\"test-test.scm\"@90.39: FAILED (check-tail-exn divide-by-zero-exception? (lambda () (/ 1 2))) GOT 1/2\n")
