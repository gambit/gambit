...
s%@srcdirpfx@%%g
s%@o@%obj%g
s%@CC_O@%cl -GX -nologo -Oityb1 -G5s -MD $(CFLAGS) -c $(CC_O_ARGS) -D___SINGLE_HOST -Tp%g
s%@CC_O_SH@%cl -GX -nologo -Oityb1 -G5s -MD $(CFLAGS) -c $(CC_O_SH_ARGS) -D___SINGLE_HOST -Tp%g
s%@LINK@%cl -GX -nologo $(LFLAGS) \\$$OBJECTS ../lib/$(GAMBCLIB) $(CLIBS) -o \\$$EXECUTABLE%g
s%@LINK_SH@%cl -GX -nologo $(LFLAGS) \\$$OBJECTS ../lib/$(GAMBCLIB_SH) -o \\$$EXECUTABLE%g
s%@LINK_SH_INSTALL@%cl -GX -nologo $(LFLAGS) \\$$OBJECTS ../lib/$(GAMBCLIB_SH) -o \\$$EXECUTABLE%g
s%@CLIBS@%%g
