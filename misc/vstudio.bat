...
if "%2%" == "" (
  set DEFS_LIB=-D___SYS_TYPE_CPU=\"x86_64\"
)
if not "%2%" == "" (
  set DEFS_LIB=-D___SYS_TYPE_CPU=\"%2%\"
)
set DEFS_LIB=%DEFS_LIB% -D___SYS_TYPE_VENDOR=\"pc\" -D___SYS_TYPE_OS=\"visualc\" 

if not "%1%" == "" (
set DEFS_LIB=%DEFS_LIB% -D___GAMBITDIR=\"%1%\"
)
set DEFS_LIB=%DEFS_LIB% -D___GAMBITDIR_USERLIB=\"~\\.gambit_userlib\"
set DEFS_LIB=%DEFS_LIB% -D___GAMBITDIR_INSTLIB=\"~~userlib\"
