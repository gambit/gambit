...
s%@srcdirpfx@%%g
s%@o@%obj%g
s%@CC_O@%c:/lcc/bin/lcc $(CFLAGS) -c $(CC_O_ARGS) -D___SINGLE_HOSTzzz%g
s%@CC_O_SH@%c:/lcc/bin/lcc $(CFLAGS) -c $(CC_O_SH_ARGS) -D___SINGLE_HOSTzzz%g
s%@LINK@%c:/lcc/bin/lcclnk $(LFLAGS) \\$$OBJECTS ../lib/$(GAMBCLIB) $(CLIBS) -o \\$$EXECUTABLE%g
s%@LINK_SH@%c:/lcc/bin/lcclnk $(LFLAGS) \\$$OBJECTS ../lib/$(GAMBCLIB_SH) -o \\$$EXECUTABLE%g
s%@LINK_SH_INSTALL@%c:/lcc/bin/lcclnk $(LFLAGS) \\$$OBJECTS ../lib/$(GAMBCLIB_SH) -o \\$$EXECUTABLE%g
s%@CLIBS@%%g
